...
class ControlCar:
    ...
    def forward(self, offset):
        ...
        elif self._straight_begin_time > 0 and time.perf_counter() - self._straight_begin_time < self._straight_delay_time:
    ...
    def go_straight(self, delay_time=8):
        if self._straight_begin_time == 0:
            self._straight_begin_time = time.perf_counter()
            self._straight_delay_time = delay_time
